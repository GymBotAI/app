    ...
    <View style={talkTo.container}>
      <View style={talkTo.titleWrapper}>
        <Text
          text="Talk To GymBot"
          variant="header-big"
          style={{ marginRight: 10, color: colors.white.default }}
        />
        <AntDesign name="message1" size={24} color={colors.grey.lightest} />
      </View>
      <Text
        text="Our special AI will give you personalized workout tips and address any and all of your fitness concerns"
        size="small"
